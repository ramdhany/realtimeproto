...
public class NumSequenceBlockingClient {


	private static final Logger logger = Logger.getLogger(NumSequenceBlockingClient.class.getName());
	...
	public NumSequenceBlockingClient(Channel channel, int messageCount, String clientId) {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (args.length > 0) {
		 ...
		 try {
			 NumSequenceBlockingClient client = new NumSequenceBlockingClient(channel, 50, "client-" + UUID.randomUUID());
